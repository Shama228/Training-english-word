...
namespace WindowsFormsApp7
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            button7.Text = "Trash";
            button8.Text = "Door";
            button16.Text = "Счастье";
            button17.Text = "Сохранить";
            button18.Text = "Кошка";
            button19.Text = "Подозрительно";
            button20.Text = "Cat";
            button21.Text = "Suspiciously";
            button22.Text = "Save";
            button23.Text = "Happiness";
        }
        ...
        private void timer2_Tick(object sender, EventArgs e)
        {
            ...
            label2.Text = "Осталось " + (int)(20 - diff.TotalSeconds) + " секунды.";
            if ((int)(20 - diff.TotalSeconds) == 0)
            {
                timer2.Stop();
